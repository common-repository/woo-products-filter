<?php
/**
 * @link            http://theemon.com/w/woo-products-filter/LivePreview
 * @since           1.0.0
 * @package         woo-products-filter
 * 
 * 
 * Plugin Name:     Woo Products Filter
 * Plugin URI:      http://theemon.com/w/woo-products-filter/LivePreview/
 * Description:     Filter and sort wocommerce products by category, product name, price, colors, etc...
 * Version:         1.0.0
 * Text Domain:     woopf
 * Domain Path:     /languages
 * Author:          Theemon
 * Author URI:      https://codecanyon.net/user/theemon/portfolio/
 * License: 
 */ 
